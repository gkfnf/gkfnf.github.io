...
var lazying = require('./lazying');

(function (factory) {
  if (typeof define === 'function' && define.amd) {
    define([], factory);
  } else if ((typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object') {
    window.Lazying = factory();
  }
})(function () {
...
},{"./lazying":2}],2:[function(require,module,exports){
'use strict';
...
var util = {
  ...
  bind: function bind(node, name, listener) {
 ...
 */
function getNodes() {
  var nodes = Array.prototype.slice.call(document.querySelectorAll('[data-src]'));
  return nodes;
}
 ...
 */
function check() {
  var nodes = util.filter(getNodes(), function (node) {
...
(function () {
  ...
  for (var i = 0, length = data.length; i < length; i++) {
    var li = '<li>' +
      ...
      '<img class="avatar" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="' + data[i].avatar_url + '" />' +
